...
summary_df <- read.csv("summary_df_spatial_sensitivity.csv")
...
name_cgsol_pr <- pool_function(variable ="Commercial Goods")
name_hsol_pr <- pool_function(variable ="House Materials")
name_zebu_pr <- pool_function(variable ="Zebu")
name_hsol_zebu_pr <- pool_function(variable ="House Materials:Zebu")
name_vanilla_zebu_pr <- pool_function(variable ="Vanilla:Zebu")
name_cgsol_zebu_pr <- pool_function(variable ="Commercial Goods:Zebu")
...
meta_df$Variable <- c("Age", "Gender[Man]", "Vanilla Farmer", "Land Size", "Household Size", "School Level",  "Commercial Goods", "House Materials", "Cattle", "House Materials:Cattle", "Vanilla:Cattle", "Commercial Goods:Cattle", "Animal Sex[Male]")
...
meta_df_filtered <- meta_df %>% filter(Variable !="Edges", Variable !="Cattle", Variable !="House Materials:Cattle", Variable !="Commercial Goods:Cattle", Variable !="Vanilla:Cattle", Variable !="Degree 1",Variable !="Degree 2",Variable !="Degree 3",Variable !="Degree 4", Variable !="Animal Sex[Male]")

meta_df_filtered$Variable <- factor(meta_df_filtered$Variable, levels = c("Age", "Gender[Man]", "School Level", "Household Size", "Land Size", "Vanilla Farmer", "Commercial Goods", "House Materials"))
...
meta_df_filtered2 <- meta_df %>% filter(Variable =="Cattle"| Variable =="House Materials:Cattle"| Variable =="Commercial Goods:Cattle"| Variable =="Vanilla:Cattle"| Variable =="Animal Sex[Male]")
meta_df_filtered2$Variable <- factor(meta_df_filtered2$Variable, levels = c("Animal Sex[Male]", "Commercial Goods:Cattle", "House Materials:Cattle", "Vanilla:Cattle", "Cattle"))
