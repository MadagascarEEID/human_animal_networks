...
meta_df$Variable <- c("Age", "Gender[Male]", "Vanilla", "Land Size", "Household Size", "School Level",  "CGSOL", "HSOL", "Cattle", "HSOL:Cattle", "Vanilla:Cattle", "CGSOL:Cattle", "Animal Sex[Male]")
